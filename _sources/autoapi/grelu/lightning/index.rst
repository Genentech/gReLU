...
.. autoapisummary::
   ...
   grelu.lightning.get_compare_func
...
.. py:class:: LightningModel(model_params: dict, train_params: dict = {}, data_params: dict = {})
   ...
   .. py:method:: predict_on_dataset(dataset: Callable, devices: Union[int, str, List[int]] = 'cpu', num_workers: int = 1, batch_size: int = 256, augment_aggfunc: Union[str, Callable] = 'mean', compare_func: Optional[Union[str, Callable]] = None, return_df: bool = False, precision: Optional[str] = None)
   ...
   .. py:method:: test_on_dataset(dataset: Callable, devices: Union[str, int, List[int]] = 'cpu', num_workers: int = 1, batch_size: int = 256, precision: Optional[str] = None)
