...
.. py:class:: LinearBlock(in_len: int, out_len: int, act_func: str = 'relu', dropout: float = 0.0, norm: bool = False, norm_kwargs: Optional[dict] = dict(), bias: bool = True, dtype=None, device=None)
...
.. py:class:: ConvBlock(in_channels: int, out_channels: int, kernel_size: int, dilation: int = 1, act_func: str = 'relu', pool_func: Optional[str] = None, pool_size: Optional[str] = None, dropout: float = 0.0, norm: bool = True, norm_type='batch', norm_kwargs: Optional[dict] = dict(), residual: bool = False, order: str = 'CDNRA', bias: bool = True, return_pre_pool: bool = False, dtype=None, device=None, **kwargs)
...
.. py:class:: ChannelTransformBlock(in_channels: int, out_channels: int, norm: bool = False, act_func: str = 'relu', dropout: float = 0.0, order: str = 'CDNA', norm_type='batch', norm_kwargs: Optional[dict] = dict(), if_equal: bool = False, dtype=None, device=None)
...
.. py:class:: ConvTower(stem_channels: int, stem_kernel_size: int, n_blocks: int = 2, channel_init: int = 16, channel_mult: float = 1, kernel_size: int = 5, dilation_init: int = 1, dilation_mult: float = 1, act_func: str = 'relu', norm: bool = False, norm_kwargs: Optional[dict] = dict(), pool_func: Optional[str] = None, pool_size: Optional[int] = None, residual: bool = False, dropout: float = 0.0, order: str = 'CDNRA', crop_len: Union[int, str] = 0, dtype=None, device=None)
...
.. py:class:: FeedForwardBlock(in_len: int, dropout: float = 0.0, act_func: str = 'relu', norm_kwargs: Optional[dict] = dict(), **kwargs)
...
.. py:class:: TransformerBlock(in_len: int, n_heads: int, attn_dropout: float, ff_dropout: float, flash_attn: bool, n_pos_features: Optional[int] = None, key_len: Optional[int] = None, value_len: Optional[int] = None, pos_dropout: Optional[float] = None, norm_kwargs: Optional[dict] = dict(), dtype=None, device=None)
...
.. py:class:: TransformerTower(in_channels: int, n_blocks: int = 1, n_heads: int = 1, n_pos_features: int = 32, key_len: int = 64, value_len: int = 64, pos_dropout: float = 0.0, attn_dropout: float = 0.0, ff_dropout: float = 0.0, norm_kwargs: Optional[dict] = dict(), flash_attn: bool = False, dtype=None, device=None)
...
.. py:class:: UnetBlock(in_channels: int, y_in_channels: int, norm_type='batch', norm_kwargs: Optional[dict] = dict(), dtype=None, device=None)
...
.. py:class:: UnetTower(in_channels: int, y_in_channels: List[int], n_blocks: int, **kwargs)
