...
.. py:function:: get_gc_matched_intervals(intervals: pandas.DataFrame, genome: str, binwidth: float = 0.1, chroms: str = 'autosomes', blacklist: str = 'hg38', seed: Optional[int] = None) -> pandas.DataFrame
