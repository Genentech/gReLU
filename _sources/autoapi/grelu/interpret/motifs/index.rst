...
.. py:function:: scan_sequences(seqs: Union[str, List[str]], motifs: Union[str, Dict[str, numpy.ndarray]], names: Optional[List[str]] = None, seq_ids: Optional[List[str]] = None, pthresh: float = 0.001, rc: bool = True, bin_size=0.1, eps=0.0001)
