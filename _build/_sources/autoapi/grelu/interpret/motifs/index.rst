...
.. py:function:: compare_motifs(ref_seq: str, alt_seq: str, motifs: Union[str, numpy.ndarray, Dict[str, numpy.ndarray]], names: Optional[List[str]] = None, pthresh: float = 0.001, rc: bool = True, ref_attrs: Optional[numpy.ndarray] = None, alt_attrs: Optional[numpy.ndarray] = None) -> pandas.DataFrame
   ...
   :param rc: If True, both the sequence and its reverse complement will be
              scanned. If False, only the given sequence will be scanned.
   :param ref_attrs: A numpy array of shape (1, 4, L) containing attributions for
                     the reference sequence.
   :param alt_attrs: A numpy array of shape (1, 4, L) containing attributions for
